...
{   
    ...
    public function all_category_product(){
        ...
        return view('admin_layout')->with('admmin.all_category_product',$manager_category_product);
    }
    ...
    public function edit_category_product($category_product_id){
        ...
        return view('admin_layout')->with('admmin.edit_category_product',$manager_category_product);
    }
