...
{   
    ...
    public function all_product(){
        ...
        return view('admin_layout')->with('admmin.all_product',$manager_product);
    }
    ...
    public function edit_product($product_id){
        ...
        return view('admin_layout')->with('admmin.edit_product',$manager_product);
    }
    ...
    public function delete_product($product_id){
        $this->AuthLogin();
        $pro_id = DB::table('tbl_order_detail')->where('product_id',$product_id)->first();
        if($pro_id){
