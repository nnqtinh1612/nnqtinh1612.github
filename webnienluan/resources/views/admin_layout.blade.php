        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/all-contact')}}">➼ Liệt kê liên hệ</a></li>
                    </ul>
                </li>
               	...
               	<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/all-customer')}}">➼ Quản lý thành viên</a></li>
                    </ul>
                </li>
...
<script type="text/javascript">
	$('.order_detail').change(function(){
		...
		$.ajax({
			...
			success:function(update_order_data){
				alert('Cập nhật tình trạng đơn hàng thành công thành công');
				location.reload();
			}
		});
